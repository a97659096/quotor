...
package com.quotorcloud.quotor.common.security.handler;
...
public abstract class AbstractAuthenticationFailureEvenHandler implements ApplicationListener<AbstractAuthenticationFailureEvent> {
	...
	/**
	 * Handle an application com.quotorcloud.quotor.academy.event.
	 *
	 * @param event the com.quotorcloud.quotor.academy.event to respond to
	 */
	@Override
