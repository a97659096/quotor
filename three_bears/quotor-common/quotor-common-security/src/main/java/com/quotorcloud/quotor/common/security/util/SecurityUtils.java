...
package com.quotorcloud.quotor.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public QuotorUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof QuotorUser) {
			return (QuotorUser) principal;
		}
		return null;
	}
