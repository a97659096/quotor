 ...
 */
public class QuotorUserAuthenticationConverter implements UserAuthenticationConverter {
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
			...
			QuotorUser user = new QuotorUser(id, name, deptId, deptName, username, N_A, true
