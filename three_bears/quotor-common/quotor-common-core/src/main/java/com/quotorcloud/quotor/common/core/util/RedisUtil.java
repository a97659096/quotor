...
public class RedisUtil {
	...
	public boolean set(String key, Object value, int indexDB) {
		return this.set(key, value, indexDB, -1);
	}
	 ...
	 * @param key 键
	 * @param value 值
	 * @param time 时间(秒) 无限期:time<0
	 * @return true成功 false 失败
	 */
	public boolean set(String key, Object value, long time){
		return this.set(key, value, 0, time);
	}
...
//	}
	 ...
	 * @return 对应的多个键值
	 */
	public Map<String, ?> hmget(String key){
