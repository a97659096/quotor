...
package com.quotorcloud.quotor.auth.endpoint;
...
public class QuotorTokenEndpoint {
	...
	public R getTokenPage(@RequestBody Map<String, Object> params, @RequestHeader(required = false) String from) {
		...
		for (String page : pages) {
			...
			if (authentication instanceof UsernamePasswordAuthenticationToken) {
				...
				if (authenticationToken.getPrincipal() instanceof QuotorUser) {
					QuotorUser user = (QuotorUser) authenticationToken.getPrincipal();
